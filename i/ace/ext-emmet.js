  ...
  function (e, t, n) {
    ...
    var d = (function () {
      ...
      return (
        ...
        (e.prototype.insertSnippetForSelection = function (e, t, n) {
          n === void 0 && (n = {});
          var r = v.call(this, e, t, n),
            i = e.getSelectionRange(),
            s = e.session.replace(i, r.text),
            o = new m(e),
            u = e.inVirtualSelectionMode && e.selection.index;
        ...
        (e.prototype.insertSnippet = function (e, t, n) {
          ...
          if (e.inVirtualSelectionMode)
            return r.insertSnippetForSelection(e, t, n);
          (e.forEachSelection(
            function () {
              r.insertSnippetForSelection(e, t, n);
            },
            null,
            { keepOrder: !0 },
          ),
    ...
    var v = function (e, t, n) {
        ...
        var r = e.getCursorPosition(),
          i = e.session.getLine(r.row),
          s = e.session.getTabString(),
          o = i.match(/^\s*/)[0];
        (r.column < o.length && (o = o.slice(0, r.column)),
          (t = t.replace(/\r/g, "")));
        var u = this.tokenizeTmSnippet(t);
        ...
        (u.forEach(function (e, t) {
          ...
          var n = e.tabstopId,
            r = a[n];
          r ||
            ((r = a[n] = []), (r.index = n), (r.value = ""), (r.parents = {}));
          if (r.indexOf(e) !== -1) return;
          (e.choices && !r.choices && (r.choices = e.choices), r.push(e));
          var i = u.indexOf(e, t + 1);
          if (i === -1) return;
          var s = u.slice(t + 1, i),
            o = s.some(function (e) {
        ...
        for (var c = 0; c < u.length; c++) {
          ...
          (typeof m != "string"
            ? (m = l(m))
            : h.fmt && (m = this.tmStrFormat(m, h, e)),
    ...
    function (e, t, n) {
          ...
          return (
            ...
            (e.prototype.createSelection = function (e, t) {
              ...
              this.ace.selection.setRange({
                start: n.indexToPosition(e),
                end: n.indexToPosition(t),
              });
            }),
            (e.prototype.getCurrentLineRange = function () {
              var e = this.ace,
                t = e.getCursorPosition().row,
                n = e.session.getLine(t).length,
            ...
            (e.prototype.getFilePath = function () {
              return "";
            }),
            (e.prototype.$updateTabstops = function (e) {
              var t = 1e3,
                n = 0,
                r = null,
                i = a.tabStops || a.require("tabStops"),
                s = a.resources || a.require("resources"),
                o = s.getVocabulary("user"),
                u = {
                  tabstop: function (e) {
                    var s = parseInt(e.group, 10),
                      o = s === 0;
                    o ? (s = ++n) : (s += t);
                    var a = e.placeholder;
              ...
              e = i.processText(e, u);
              if (o.variables.insert_final_tabstop && !/\$\{0\}$/.test(e))
                e += "${0}";
              else if (r) {
      ...
      ((t.commands = new r()),
        (t.runEmmetCommand = function v(e) {
          if (this.action == "expand_abbreviation_with_tab") {
            ...
            var n = e.selection.lead,
              r = e.session.getTokenAt(n.row, n.column);
      ...
      ((t.updateCommands = function (e, n) {
        ...
        (t.isSupportedMode = function (e) {
          ...
          var t = e.$id || e;
          return /css|less|scss|sass|stylus|html|php|twig|ejs|handlebars/.test(
            t,
          );
        }),
        (t.isAvailable = function (e, n) {
          if (/(evaluate_math_expression|expand_abbreviation)$/.test(n))
            return !0;
          var r = e.session.$mode,
      ...
      var d = function (e, n) {
        ...
        (e.enableEmmet === !1 && (i = !1),
          i && t.load(),
          t.updateCommands(r, i));
      };
      ((t.load = function (e) {
        return typeof f != "string"
          ? !1
          : (u.loadModule(f, function () {
              ((f = null), e && e());
            }),
            !0);
      }),
        ...
        u.defineOptions(i.prototype, "editor", {
          enableEmmet: {
            set: function (e) {
              (this[e ? "on" : "removeListener"]("changeMode", d),
                d({ enableEmmet: !!e }, this));
            },
            value: !0,
          },
        }),
