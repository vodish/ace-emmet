  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var c = (t.addListener = function (e, t, n, r) {
          (e.addEventListener(t, n, f()),
            r && r.$toDestroy.push(new l(e, t, n)));
        }),
        ...
        y = function (e, t) {
          ...
          ((this.setNumberOfExtraLines = function (e) {
            ...
            (this.setAriaOptions = function (e) {
              ...
              if (e.setLabel) {
                n.setAttribute("aria-roledescription", i("editor"));
                if (t.session) {
                  var r = t.session.selection.cursor.row;
                  n.setAttribute("aria-label", i("Cursor at row $0", [r + 1]));
                }
              }
            }),
            ...
            (this.focus = function () {
              ...
              if (r) {
                ...
                while (o && o.nodeType == 1)
                  (s.push(o),
                    o.setAttribute("ace_nocontext", !0),
                    !o.parentElement && o.getRootNode
          ...
          var P = function (e, n) {
              var r = n;
              for (var i = 1; i <= e - A && i < 2 * M + 1; i++)
                r += t.session.getLine(e - i).length + 1;
              return r;
            },
            H = v
              ? function (e) {
              ...
              : function () {
                  ...
                  if (t.session) {
                    ...
                    if (u === O + 1) ((A = O + 1), (O = A + 2 * M));
                      ...
                      ((A = u > M ? u - M : 0), (O = u > M ? u + M : 2 * M));
                    var a = [];
                    for (var f = A; f <= O; f++) a.push(t.session.getLine(f));
                    ((i = a.join("\n")),
                      (e = P(o.start.row, o.start.column)),
                      (r = P(o.end.row, o.end.column)));
                    if (o.start.row < A) {
                      ...
                      ((r = o.end.row > O + 1 ? c.length : o.end.column),
                        (r += i.length + 1),
                        (i = i + "\n" + c));
                    } else g && u > 0 && ((i = "\n" + i), (r += 1), (e += 1));
                    i.length > h &&
          ...
          (r.addCommandKeyListener(n, t.onCommandKey.bind(t), t),
            r.addListener(n, "select", j, t),
            r.addListener(n, "input", R, t),
            r.addListener(n, "cut", W, t),
            r.addListener(n, "copy", X, t),
            r.addListener(n, "paste", V, t),
          ...
          (r.addListener(n, "compositionstart", $, t),
            r.addListener(n, "compositionupdate", J, t),
            r.addListener(n, "keyup", Y, t),
            r.addListener(n, "keydown", G, t),
            r.addListener(n, "compositionend", K, t),
            ...
            (this.moveToMouse = function (e, i) {
              ...
              ((t.renderer.$isMousePressed = !0),
                clearTimeout(Z),
                s.isWin && r.capture(t.container, h, et));
            }),
          ...
          (r.addListener(n, "mouseup", tt, t),
            ...
            r.addListener(t.renderer.scroller, "contextmenu", tt, t),
            r.addListener(n, "contextmenu", tt, t),
            v && nt(e, t, n),
      ...
      var l = (function (e) {
        ...
        return (
          ...
          (t.prototype.showTooltip = function (e) {
            var n = this.editor.renderer.$gutterLayer,
              r = n.$annotations[e],
              i;
            r
          ...
          return (
            ...
            (e.prototype.getGutterRow = function () {
              var e = this.getDocumentPosition().row,
                t = this.editor.session.documentToScreenRow(e, 0),
                n = this.editor.session.documentToScreenRow(
        ...
        d = (function () {
          ...
          return (
            ...
            (e.prototype.getScreenLength = function () {
              ...
              return (
                this.lineWidgets && (e += this.$getWidgetScreenLength()),
                e
              );
            }),
    ...
    function (e, t, n) {
      ...
      function u(e, t) {
        function i(e, r) {
          r === void 0 && (r = !0);
          var i =
            n && t.$supportsUnicodeFlag
              ? new RegExp("[\\p{L}\\p{N}_]", "u")
              : new RegExp("\\w");
          if (i.test(e) || t.regExp)
            return n && t.$supportsUnicodeFlag
              ? r
                ? "(?<=^|[^\\p{L}\\p{N}_])"
                : "(?=[^\\p{L}\\p{N}_]|$)"
              : "\\b";
        ...
        o = (function () {
          ...
          return (
            ...
            (e.prototype.$assembleRegExp = function (e, t) {
              ...
              e.$supportsUnicodeFlag === undefined &&
                (e.$supportsUnicodeFlag = r.supportsUnicodeFlag());
              try {
                new RegExp(n, "u");
              } catch (i) {
          ...
          function t(t, n) {
            ...
            return (
              ...
              r.setDefaultHandler("exec", function (e) {
                return e.args
                  ? e.command.exec(e.editor, e.args, e.event, !1)
                  : e.command.exec(e.editor, {}, e.event, !0);
              }),
              r
            );
          }
        ...
        s = (function () {
          function e(e) {
            ((this.editor = e),
              ...
              (this.annotationTooltip = new i(this.editor)));
          }
          return (
            ...
            (e.prototype.$onGutterKeyDown = function (e) {
              ...
              if (e.target === this.element) {
                ...
                (this.editor.isRowVisible(t) ||
                  this.editor.scrollToLine(t, !0, !0),
                  setTimeout(
                    function () {
            ...
            (e.prototype.$focusFoldWidget = function (e) {
              ...
              (t.classList.add(this.editor.renderer.keyboardFocusClassName),
                t.focus());
            }),
            ...
            (e.prototype.$blurFoldWidget = function (e) {
              var t = this.$getFoldWidget(e);
              (t.classList.remove(this.editor.renderer.keyboardFocusClassName),
                t.blur());
            }),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      ((N.$uid = 0),
        ...
        y.defineOptions(N.prototype, "editor", {
          selectionStyle: {
            set: function (e) {
              (this.onSelectionChange(),
            ...
            set: function (e) {
              ...
              e
                ? ((this.renderer.enableKeyboardAccessibility = !0),
                  ...
                  this.textInput.setNumberOfExtraLines(u.isWin ? 3 : 0),
        ...
        return (
          ...
          (e.prototype.scrollBy = function (e, t) {
            (t && this.session.setScrollTop(this.session.getScrollTop() + t),
              e &&
                this.session.setScrollLeft(this.session.getScrollLeft() + e));
          }),
          ...
          (e.prototype.removeExtraToken = function (e, t) {
            ((this.session.bgTokenizer.lines[e] = null),
      ...
      (e("./worker/worker_client"),
        ...
        (t.edit = function (e, n) {
          ...
          var f = t.createEditSession(o),
            l = new s(new a(e), f, n),
            c = { document: f, editor: l, onResize: l.resize.bind(l, null) };
          return (
            u && (c.textarea = u),
